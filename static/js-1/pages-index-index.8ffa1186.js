(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[
  ...
  "001b": function (e, t, i) {
    ...
    var a = {
      ...
      n = function () {
        ...
        return i("v-uni-view", { staticClass: "body" }, [
          i("u-navbar", {
            staticClass: "navbar",
            attrs: {
              placeholder: !0,
            ...
            e._l(e.list, function (t) {
              return i("v-uni-view", {
                ...
                t.lockFlag && !e.lockVip
                  ? i("u-icon", {
                    attrs: { name: "lock", color: "#919398", size: "16" },
                  })
                  : e._e(),
              ], 1);
            }),
          ...
          i("v-uni-view", {
            ...
            i("u-popup", {
              ...
              i("v-uni-view", [
                i("v-uni-view", { staticClass: "tip-box" }, [
                  i("v-uni-view", { staticClass: "tip-text" }, [
                    e._v("语音提示"),
                  ]),
                  i("u-switch", {
                    attrs: { value: e.voiceOpen, activeColor: "#e47470" },
                    on: {
                      change: function (t) {
                        arguments[0] = t = e.$handleEvent(t),
                          e.voiceOpenChange.apply(void 0, arguments);
                      },
                    },
                  }),
                ], 1),
                ...
                i("v-uni-view", {
                  ...
                  i("v-uni-view", { staticClass: "tip-text" }, [e._v("版本")]),
                  i("u-icon", {
                    attrs: {
                      name: "arrow-right",
                      label: e.v,
        ...
        a && Object.deepExtend(s, a),
          ...
          s.fn.retinaInit = function () {
            s.retina_detect && window.devicePixelRatio > 1
              ? (s.canvas.pxratio = window.devicePixelRatio, s.tmp.retina = !0)
              ...
              s.particles.size.anim.speed = s.tmp.obj.size_anim_speed *
                s.canvas.pxratio,
              ...
              s.particles.line_linked.width = s.tmp.obj.line_linked_width *
                s.canvas.pxratio,
              s.interactivity.modes.bubble.size = s.tmp.obj.mode_bubble_size *
                s.canvas.pxratio,
          ...
          s.fn.canvasSize = function () {
            s.canvas.el.width = s.canvas.w,
              ...
              s && s.interactivity.events.resize &&
          ...
          s.fn.particle = function (e, i, a) {
            if (
              this.radius = (s.particles.size.random ? Math.random() : 1) *
            ...
            this.opacity = (s.particles.opacity.random ? Math.random() : 1) *
          ...
          s.fn.particle.prototype.draw = function () {
            ...
            if (e.color.rgb) {
              var a = "rgba(" + e.color.rgb.r + "," + e.color.rgb.g + "," +
                e.color.rgb.b + "," + i + ")";
            } else {a = "hsla(" + e.color.hsl.h + "," + e.color.hsl.s + "%," +
                e.color.hsl.l + "%," + i + ")";}
            switch (
              s.canvas.ctx.fillStyle = a, s.canvas.ctx.beginPath(), e.shape
            ) {
              case "circle":
          ...
          s.fn.particlesCreate = function () {
            for (var e = 0; e < s.particles.number.value; e++) {
              s.particles.array.push(
                new s.fn.particle(s.particles.color, s.particles.opacity.value),
              );
            }
          },
          s.fn.particlesUpdate = function () {
            for (var e = 0; e < s.particles.array.length; e++) {
              ...
              if (
                s.particles.opacity.anim.enable && (1 == t.opacity_status
                  ...
                  s.particles.size.anim.enable && (1 == t.size_status
          ...
          s.fn.interact.linkParticles = function (e, t) {
            ...
            if (n <= s.particles.line_linked.distance) {
              var r = s.particles.line_linked.opacity -
                n / (1 / s.particles.line_linked.opacity) /
                  s.particles.line_linked.distance;
              if (r > 0) {
                var o = s.particles.line_linked.color_rgb_line;
                s.canvas.ctx.strokeStyle = "rgba(" + o.r + "," + o.g + "," +
                  o.b + "," + r + ")",
            ...
            if (
              ...
              if (n <= s.interactivity.modes.bubble.distance) {
                if (o >= 0 && "mousemove" == s.interactivity.status) {
                  if (
                    s.interactivity.modes.bubble.size != s.particles.size.value
                  ) {
                    if (
                      s.interactivity.modes.bubble.size > s.particles.size.value
                    ) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      u = e.opacity -
                        (s.particles.opacity.value -
                            s.interactivity.modes.bubble.opacity) * o;
                      u < e.opacity &&
                        u >= s.interactivity.modes.bubble.opacity &&
                        (e.opacity_bubble = u);
                    }
              ...
              var d = function (t, i, a, r, o) {
                if (t != i) {
                  ...
                  } else {"size" == o && (e.radius_bubble = void 0),
              ...
              if (s.tmp.bubble_clicking) {
                ...
                (s.tmp.bubble_duration_end = !0),
                  ...
                  (s.tmp.bubble_clicking = !1, s.tmp.bubble_duration_end = !1);
              }
          ...
          s.fn.modes.repulseParticle = function (e) {
            if (
              ...
              "bounce" == s.particles.move.out_mode
                ? (l.x - e.radius > 0 && l.x + e.radius < s.canvas.w &&
                  (e.x = l.x),
                  l.y - e.radius > 0 && l.y + e.radius < s.canvas.h &&
                  (e.y = l.y))
                : (e.x = l.x, e.y = l.y);
            } else if (
              s.interactivity.events.onclick.enable &&
              ...
              if (
                ...
                (s.tmp.repulse_count++,
                  ...
                  (s.tmp.repulse_finish = !0)), s.tmp.repulse_clicking
              ) {
          ...
          s.fn.modes.grabParticle = function (e) {
            if (
              ...
              if (a <= s.interactivity.modes.grab.distance) {
                var n = s.interactivity.modes.grab.line_linked.opacity -
                  a / (1 / s.interactivity.modes.grab.line_linked.opacity) /
                    s.interactivity.modes.grab.distance;
                if (n > 0) {
                  var r = s.particles.line_linked.color_rgb_line;
                  s.canvas.ctx.strokeStyle = "rgba(" + r.r + "," + r.g + "," +
                    r.b + "," + n + ")",
                    s.canvas.ctx.lineWidth = s.particles.line_linked.width,
                    s.canvas.ctx.beginPath(),
                    s.canvas.ctx.moveTo(e.x, e.y),
          ...
          s.fn.vendors.eventsListeners = function () {
            "window" == s.interactivity.detect_on
              ...
              (s.interactivity.events.onhover.enable ||
                s.interactivity.events.onclick.enable) &&
              (s.interactivity.el.addEventListener("mousemove", function (e) {
          ...
          s.fn.vendors.densityAutoParticles = function () {
            if (s.particles.number.density.enable) {
              ...
              var t = e * s.particles.number.value /
          ...
          s.fn.vendors.createSvgImg = function (e) {
            var t = s.tmp.source_svg,
              i = t.replace(/#([0-9A-F]{3,6})/gi, function (t, i, a, n) {
                if (e.color.rgb) {
                  var r = "rgba(" + e.color.rgb.r + "," + e.color.rgb.g + "," +
            ...
            "image" == s.particles.shape.type
              ? "svg" == s.tmp.img_type && void 0 == s.tmp.source_svg
                ...
                : (cancelRequestAnimFrame(s.tmp.checkAnimFrame),
                  s.tmp.img_error || (s.fn.vendors.init(), s.fn.vendors.draw()))
  ...
  "50ff": function (e, t, i) {
    ...
    var a = function () {
        var e = this, t = e.$createElement, i = e._self._c || t;
        return i("v-uni-view", { staticClass: "u-code-input" }, [
          e._l(e.codeLength, function (t, a) {
            return i("v-uni-view", {
              ...
              e.dot && e.codeArray.length > a
                ? i("v-uni-view", { staticClass: "u-code-input__item__dot" })
                : i("v-uni-text", {
                  style: {
      ...
      r = {
        ...
        computed: {
          ...
          itemStyle: function () {
            ...
            return function (t) {
              ...
              return "box" === e.mode &&
                (a.border = "".concat(e.hairline ? .5 : 1, "px solid ").concat(
                  e.borderColor,
                ),
                  ...
                  (0 === t &&
                    ...
                    t !== e.codeLength.length - 1 && (a.borderRight = "none"))),
                t !== e.codeLength.length - 1
          ...
          lineStyle: function () {
            var e = {};
            return e.height = this.hairline ? "2px" : "4px",
        ...
        methods: {
          inputHandler: function (e) {
            ...
            this.inputValue = i,
              this.disabledDot && this.$nextTick(function () {
        ...
        return i("u-popup", {
          ...
          i("v-uni-view", {
            ...
            i("v-uni-view", {
              ...
              e._t("default", [
                i("v-uni-text", { staticClass: "u-modal__content__text" }, [
                  e._v(e._s(e.content)),
                ]),
              ]),
            ], 2),
                ...
                i("v-uni-view", {
                  ...
                  e.showCancelButton
                    ? i("v-uni-view", {
                      ...
                      class: [
                        e.showCancelButton && !e.showConfirmButton &&
                      ...
                      on: {
                        click: function (t) {
                          arguments[0] = t = e.$handleEvent(t),
                            e.cancelHandler.apply(void 0, arguments);
                        },
                      },
                    }, [
                      i("v-uni-text", {
                  ...
                  e.showConfirmButton
                    ? i("v-uni-view", {
                      ...
                      on: {
                        click: function (t) {
                          arguments[0] = t = e.$handleEvent(t),
                            e.confirmHandler.apply(void 0, arguments);
                        },
                      },
                    }, [
                      e.loading
    ...
    var a = { uLoadingIcon: i("cf6a").default },
      n = function () {
        ...
        return i("v-uni-view", {
          ...
          i("v-uni-view", { staticClass: "u-switch__bg", style: [e.bgStyle] }),
          i("v-uni-view", {
            ref: "u-switch__node",
      ...
      r = {
        ...
        watch: {
          value: {
            immediate: !0,
            handler: function (e) {
              e !== this.inactiveValue && e !== this.activeValue &&
                uni.$u.error(
        ...
        computed: {
          ...
          switchStyle: function () {
            var e = {};
            return e.width = uni.$u.addUnit(2 * this.size + 2),
              e.height = uni.$u.addUnit(Number(this.size) + 2),
              this.customInactiveColor && (e.borderColor = "rgba(0, 0, 0, 0)"),
          ...
          {},
          {
            ...
            weGo: function (e) {
              if (this.lockVip || !e.lockFlag) {
                if (!this.stop) {
                  if (
                    this.stop = !0, e.id != this.list[this.list.length - 1].id
                  ) {
